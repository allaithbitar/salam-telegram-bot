...
export const STRINGS = {
  WELCOME_MESSAGE: `📌 تعليمات استخدام بوت همسة سلام

مرحبًا بك في مساحتك الآمنة 
هنا، فيك تسأل أسئلة نفسية صغيرة وتاخد رد أولي من مرشدين متدرّبين، بخطوة أولى نحو الفهم والدعم.
البوت مو علاج نفسي كامل، لكنه مساحة تسمعك، تساعدك توضّح أفكارك، وتوجّهك إذا احتجت لمختص.


1️⃣ كيف تستخدم البوت:

▫️ احكي عن شعور، موقف، أو فكرة مقلقة عم تعيشها.
▫️ رح توصلك استجابة أولية من مرشد متدرّب.
▫️ إذا بيحتاج وضعك متابعة، فريقنا ممكن يوجّهك لمختص موثوق يناسب حالتك.


2️⃣ قبل ما تبلّش:

▫️ فكّر شوي شو اللي حابب تحكي عنه أو تسأل عنه، وجرّب تكتبه بوضوح.
▫️ كل محادثة مدتها 15 دقيقة لضمان استجابة للجميع.
▫️ المرشد ممكن ينهي الجلسة بعد الوقت المحدد بلطف.


3️⃣ الخصوصية والأمان:

▫️ ما تشارك أي معلومات شخصية (رقم هاتف، حسابات، عنوان…).
▫️ هويتك محمية بالكامل، وما في حدا بيقدر يعرف بياناتك.
▫️ أي إساءة أو تجاوز بيتسبب بإيقاف الخدمة فورًا والحظر.


نحن هون لنسمعك، لنفهَم معك، ولنكون اليد التي تحملك إلى السلام 🤍`,
  LOADING: "جار التحميل ...",
